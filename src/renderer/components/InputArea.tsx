    ...
    <div className="border-t border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-800" ref={containerRef}>
      ...
      <div className="relative">
        {mention.active && filteredAgents.length > 0 && (
          <div className="absolute bottom-full left-0 z-10 mb-2 max-h-64 w-72 overflow-y-auto rounded-lg border border-slate-200 bg-white shadow-lg dark:border-slate-700 dark:bg-slate-800">
